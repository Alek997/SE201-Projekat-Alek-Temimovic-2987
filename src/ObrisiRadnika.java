...
public class ObrisiRadnika extends Application {

    @Override
    public void start(Stage primaryStage) {
        Scene scene = new Scene(new Group());
        primaryStage.setTitle("Obrisi radnika");
        primaryStage.setWidth(350);
        primaryStage.setHeight(450);

        final Label nazivT = new Label("Unesite JMBG radnika");
        ...
        btn.setOnAction((ActionEvent event) -> {
            ...
            Baza.deleteRadnik(jmbgTX.getText().trim());
            Baza.disconnect();
        });
